...
const InfoBase = {
  id: ID,
  // Opaque owner identifier. Usually a Session ID, but global producers such as MCP elicitation
  // use sentinel values that never correspond to a persisted session row.
